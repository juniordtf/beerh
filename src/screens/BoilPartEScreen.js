...
class BoilPartEScreen extends Component {
  ...
  getHopName() {
    let currentRecipe = this.state.todaysRecipe;
    let hopName = currentRecipe.boil ? currentRecipe.boil[4].name : '';
    return hopName;
  }

  getHopQuantity() {
    let currentRecipe = this.state.todaysRecipe;
    let hopQuantity = currentRecipe.boil ? currentRecipe.boil[4].quantity : 1;
    return hopQuantity;
  }

  getHopUnit() {
    let currentRecipe = this.state.todaysRecipe;
    let hopUnit = currentRecipe.boil ? currentRecipe.boil[4].unit : 'g';
    return hopUnit;
  }
