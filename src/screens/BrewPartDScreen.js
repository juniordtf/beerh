...
class BrewPartDScreen extends Component {
  constructor(props) {
    super(props);
  ...
  startTimer() {
    ...
    if (currentRecipe != null && currentRecipe.ramps !== undefined) {
      rampDuration = parseInt(currentRecipe.ramps[2].time, 10) - 1;
    }

    window.timerComponent.setTimer(
      rampDuration,
      'Tempo da 3ª rampa alcançado!',
    );
  ...
  getInitialTemperature() {
    ...
    if (currentRecipe != null && currentRecipe.ramps !== undefined) {
      return parseFloat(currentRecipe.ramps[2].temperature, 10).toFixed(1);
    }
  ...
  goToNextView = () => {
    ...
    const productionUpdated = {
      ...
      viewToRestore: 'Brassagem Parte D',
  ...
  decideNextView = (productionUpdated) => {
    if (this.state.todaysRecipe.ramps[3] != null) {
      this.props.navigation.navigate('Brassagem Parte E', {
            ...
            <View style={styles.rowContainer}>
              ...
              <View style={styles.sectionContainerRight}>
                <Text style={styles.bodyText}>
                  3ª Rampa - Brassagem (4/{this.getStepsTotal()})
                </Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              <Text style={styles.modalText}>
                O tempo da 3ª rampa ainda não foi atingido. Deseja realmente
                avançar?
              </Text>
              <View style={styles.rowContainer}>
                <TouchableHighlight
...
export default BrewPartDScreen;
